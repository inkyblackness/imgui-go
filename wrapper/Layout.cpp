...
void iggBeginHorizontal(char const *id, IggVec2 const *size, float align)
{
   Vec2Wrapper sizeArg(size);
   ImGui::BeginHorizontal(id, *sizeArg, align);
}

void iggEndHorizontal()
{
   ImGui::EndHorizontal();
}

void iggBeginVertical(char const *id, IggVec2 const *size, float align)
{
   Vec2Wrapper sizeArg(size);
   ImGui::BeginVertical(id, *sizeArg, align);
}
...
void iggSpring(float weight, float spacing)
{
   ImGui::Spring(weight, spacing);
}

void iggSuspendLayout()
{
   ImGui::SuspendLayout();
}

void iggResumeLayout()
{
   ImGui::ResumeLayout();
}
