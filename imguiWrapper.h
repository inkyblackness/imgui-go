...
extern IggBool iggDragInt( char const *label, int *value, int speed, int min, int max, char const *format);

extern IggBool iggSliderFloat(char const *label, float *value, float minValue, float maxValue, char const *format);
extern IggBool iggDragFloat( char const *label, float *value, float speed, float min, float max,  char const *format);
